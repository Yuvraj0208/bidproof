...
export function LearnedNote({ learned }: { learned: LearnedPrefill }) {
  return (
    <div
      ...
      className="mt-1 rounded border border-indigo-200 bg-indigo-50 px-2 py-1 text-[11px] text-indigo-800"
    >
      <span className="font-medium">🧠 Pre-filled: </span>
      <span className="font-medium text-indigo-900">{learned.suggested_value}</span>
